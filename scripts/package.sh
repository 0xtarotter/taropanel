...
for file in server.js operations.js platform.js security.js ssh.js package.json package-lock.json install.sh README.md SECURITY.md LICENSE CONTRIBUTING.md CHANGELOG.md .gitignore; do cp "$file" "$stage/taropanel/"; done
cp -a scripts tests deploy docs .github "$stage/taropanel/"
